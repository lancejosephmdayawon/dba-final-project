...
export default function AdminPaymentsDashboard() {
  ...
  const filteredTransactions =
    filter === "all"
      ? transactions
      : transactions.filter((tx) => tx.payment_status === filter);
  ...
  return (
    <div className="mx-6 my-6">
      ...
      <div className="bg-blue-50 rounded-2xl shadow-lg p-6 space-y-6">
        {/* Header */}
              ...
              >
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-full font-medium flex items-center gap-2 transition
      ${
        tx.payment_status === "paid"
          ...
          : "bg-green-100 text-green-800 hover:bg-green-200"
                  ...
                  <button
                    ...
                    className="px-3 py-1 rounded-full flex items-center gap-1 text-sm text-gray-500 hover:bg-gray-100 transition"
                  >
